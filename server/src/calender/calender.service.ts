...
async endEvent(client: OAuth2Client, eventId: string): Promise<EventUpdateResponse> { 
...
if (now > new Date(event.end.dateTime)) { 
...
this.logger.log('[EndEvent] Meeting has been ended: ' + JSON.stringify(result)); 
