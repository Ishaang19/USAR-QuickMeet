...
handleEndMeeting?: (eventId: string) => void; 
...
const EventCard = ({ sx, event, onDelete, handleEditClick, isEditable, handleEventResponse, handleEndMeeting, hideMenu }: EventCardProps) => { 
...
<MenuItem key="end" onClick={onEndMeetingClick}> 
...
typeof handleEndMeeting === 'function' && handleEndMeeting(event.eventId!); 
...
export default EventCard; import { Typography, Chip, IconButton, Box, styled, Theme, SxProps, Menu, MenuItem, Tooltip } from '@mui/material'; 
